...
$minLongitudeDestination = $departureLongitude - $deltaLongitudeDestination;
		...
		<div class='container-fluid'>
			<div class='row'>
				...
				<div class='col-sm-7 journey'>
					<div><span class='tripdeparture' style='font-weight: bold; font-size: 1.5em;'>Departure:</span> $tripDeparture.</div>
					<div><span class='tripdestination' style='font-weight: bold; font-size: 1.5em;'>Destination:</span> $tripDestination.</div>
					<div class='time'>$time</div>
					<div>$frequency</div>
				</div>
				<div class='col-sm-3 journey2'>
